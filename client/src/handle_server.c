...
void handle_create_user_response(struct server_options * options, struct binary_header_field * binaryHeaderField, char * body);
void handle_create_channel_response(struct server_options * options, struct binary_header_field * binaryHeaderField, char * body);
void handle_create_message_response(struct server_options * options, struct binary_header_field * binaryHeaderField, char * body);
void handle_create_auth_response(struct server_options * options, struct binary_header_field * binaryHeaderField, char * body);
...
void handle_server_create(struct server_options * options, struct binary_header_field * binaryHeaderField, char * body) {
    ...
    {
        case USER:
            handle_create_user_response(options, binaryHeaderField, body);
            break;
        case CHANNEL:
            handle_create_channel_response(options, binaryHeaderField, body);
            break;
        case MESSAGE:
            handle_create_message_response(options, binaryHeaderField, body);
            break;
        case AUTH:
            handle_create_auth_response(options, binaryHeaderField, body);
            break;
        default:
            break;
    }
